"""
scripts/prepare_data.py — Pre-process TransMuCoRes data into JSONL files for training.
...
def main(config_path: str = "config.yaml") -> None:
    ...
    from coref.data.dataset_builder import load_documents, build_examples, save_jsonl
